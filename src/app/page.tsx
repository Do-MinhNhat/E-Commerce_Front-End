      ...
      <section className="py-8 sm:py-12 px-4 sm:px-0">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {[
            ...
            >
              <div className="h-24 sm:h-32 flex justify-center items-center bg-gradient-to-br from-blue-400 to-blue-600 rounded-lg mb-3 sm:mb-4 group-hover:scale-105 transition-transform" >
        ...
        <div className="text-center px-4">
          ...
          <form className="flex flex-col sm:flex-row gap-2 max-w-sm mx-auto">
            <input
              ...
              className="flex-1 px-4 py-2 sm:py-3 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-300 text-base bg-white"
            />
            <button
              type="submit"
              className="bg-black hover:bg-blue-800 active:bg-blue-900 px-6 py-2 sm:py-3 rounded-lg font-semibold transition-colors touch-manipulation min-h-[44px] sm:min-h-auto"
            >
              Subscribe
            </button>
          </form>
